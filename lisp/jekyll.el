;; Downloaded from https://github.com/metajack/jekyll/blob/master/emacs/jekyll.el
;; Copyright: metajack
;; jekyll.el
;; 
...
(defcustom jekyll-directory nil
  "Path to Jekyll blog.")
...
contains the date."
  ...
  (cond
   ...
   (t
    (replace-string "date: " (concat "date: " (format-time-string "%Y-%m-%d %H:%M:%S %z")) nil (point-min)(point-max))
    (save-buffer)
    (let ((filename 
